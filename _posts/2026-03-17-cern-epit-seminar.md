...
![Archi architecture]({{ site.baseurl }}/assets/images/archi-architecture.png)
...
![Archi Grafana dashboard]({{ site.baseurl }}/assets/images/news/archi-grafana.png)
